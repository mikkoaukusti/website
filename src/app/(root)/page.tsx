  ...
  return (
    <>
      <section className="flex flex-col items-start justify-center gap-y-2">
        <span className="text-xs text-neutral-500 font-medium dark:text-neutral-500">
          Health Technology / Software Engineer
        </span>
        <span className="text-sm text-neutral-600 font-medium dark:text-neutral-400">
          Hi, I&apos;m 23 y/o fourth-year ICT student from Turku! I enjoy
        ...
        <span className="text-sm text-neutral-600 font-medium dark:text-neutral-400">
          ...
          <a
            ...
            className="text-neutral-900 border-b hover:border-b-neutral-600 dark:text-white dark:hover:border-b-white"
          >
            Hit me up!
          </a>
        </span>
